CLASS zcl_jit_dataentry DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_jit_dataentry IMPLEMENTATION.

 METHOD if_oo_adt_classrun~main.

  DATA lt_demo TYPE STANDARD TABLE OF zjit_demo_exp.
...
*      // Add 9 more records for total 15
    ...
    " Insert or update
    MODIFY zjit_demo_exp FROM TABLE @lt_demo.
